...
```json
{
  "receive_scene": "group",
  "receiver": [
    { "value_type": "group", "value": { "id": "oc_xxxx", "name": "测试群" } }
  ],
  "scope": "all",
  "filter": {
    "conjunction": "and",
    ...
    "sender_contains": [
      { "value_type": "user", "value": { "id": "ou_xxxx", "name": "" } }
    ],
    "is_new_message": true,
...
```json
{
  ...
  "field_values": [
    {
      "field_name": "客户名称",
      "value": [{ "value_type": "text", "value": "张三" }]
    },
    {
      "field_name": "金额",
  ...
  "field_values": [
    {
      "field_name": "状态",
      "value": [
        { "value_type": "option", "value": { "id": "opt1", "name": "已完成" } }
      ]
    }
  ],
...
```json
{
  ...
  "max_loop_times": 100,
  "data": [
    { "value_type": "ref", "value": "$.find_record_stepIdxxx.fieldRecords" }
  ]
}
```
    ...
    },
    {
      ...
      "data": {
        ...
        "field_values": [
          {
            "field_name": "审批状态",
            "value": [{ "value_type": "text", "value": "已通过" }]
          }
        ]
      }
    },
