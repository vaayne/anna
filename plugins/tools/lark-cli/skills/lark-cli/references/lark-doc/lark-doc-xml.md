...
<p>
  <b>加粗文本</b>，<span text-color="green">绿色文本</span>
</p>
...
<table>
  ...
  <thead>
    <tr>
      <th background-color="light-gray">表头</th>
      <th background-color="light-gray">表头</th>
    </tr>
  </thead>
  <tbody>
...
<p>
  ...
  <cite type="user" user-id="USER_ID"></cite>
</p>
...
<time
  expire-time="1775916000000"
  notify-time="1775912400000"
  should-notify="false"
>时间戳毫秒</time>
