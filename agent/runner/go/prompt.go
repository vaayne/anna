...
// BuildSystemPrompt composes the full system prompt from the base prompt and persona files
// found under agentsDir (e.g. ".agents").
func BuildSystemPrompt(agentsDir string) string {
